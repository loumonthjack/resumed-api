...
import { contact, section5Title, social } from '../../newProfile'
                ...
                <div className="col-12 col-sm-6 half">
                    <form action={contact.contactUrl ? contact.contactUrl : "https://formspree.io"} method={contact.contactUrl ? "POST" : "GET"}>
                        ...
                        <button onClick={async (e) => {
                                e.preventDefault();
                                window.open(`mailto:${contact.email}?subject=${document.getElementById("sub").value}&body=${document.getElementById("msg").value}`);
